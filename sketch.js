var bg,sleep, brush, gym, eat, bath, move,otherexercise;
var astronaut;
...
function preload(){
  ...
  otherexercise=loadAnimation("images/gym11.png","images/gym11.png","images/gym12.png","images/gym12.png")
...
function draw() {
  ...
  text("a key = other exercise",20, 145);
  ...
  if(keyDown("a")){
    astronaut.addAnimation("GYMMING", otherexercise);
    astronaut.changeAnimation("GYMMING");
    astronaut.y = 350;
    astronaut.velocityX = 0;
    astronaut.velocityY = 0;
